...
public class Main {
	...
	/**
	 * Imprime menu de opções do nosso sistema bancario
	 */
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Eduardo Gomes", 37, "eduardo.gomes@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Jose da Silva", 34, "josesilva@gmail.com", conta02.getId(), true);
